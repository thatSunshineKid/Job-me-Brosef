  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved job_application as @job_application" do
        ...
        post :create, {:job_application => { "company_name" => "invalid value" }}, valid_session
        assigns(:job_application).should be_a_new(JobApplication)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested job_application" do
        ...
        JobApplication.any_instance.should_receive(:update_attributes).with({ "company_name" => "MyString" })
        put :update, {:id => job_application.to_param, :job_application => { "company_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the job_application as @job_application" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        JobApplication.any_instance.stub(:save).and_return(false)
        put :update, {:id => job_application.to_param, :job_application => { "company_name" => "invalid value" }}, valid_session
        assigns(:job_application).should eq(job_application)
      end
